...
def main():
    ...
    dev_subparsers.add_parser("setup", help="Initialize a db")
    dev_subparsers.add_parser("init", help="Initialize a project")
    dev_subparsers.add_parser("install", help="Install a new game")
    dev_subparsers.add_parser("update_version", help="Update the project version")

    dev_test_parser = dev_subparsers.add_parser("test", help="Run test cases")
    dev_test_parser.add_argument("-p", "--performance", action="store_true", help="Run performance test cases")
    dev_test_parser.add_argument("-t", "--unit", action="store_true", help="Run unit test cases")

    dev_debug_parser = dev_subparsers.add_parser("debug", help="Run test cases")
    dev_debug_parser.add_argument("-a", "--activate", action="store_true", help="Activate debugging")
    dev_debug_parser.add_argument("-d", "--deactivate", action="store_true", help="Deactivate debugging")
    ...
    if args.command == "dev":
        if args.subcommand == "setup":
            ...
            if args.performance:
                run_vt_runner("performance", load_game_commands())
            elif args.unit:
                run_vt_runner("test", load_game_commands())
            else:
