...
class RemoteCommandTests(unittest.TestCase):
    ...
    def test_run_remote_rtp_uploads_script_and_starts_tmux(self):
        ...
        self.assertIn("[remote-step] check-sessions", output)
        self.assertIn("[remote-step] prepare-dir", output)
        self.assertIn("[remote-step] upload-script", output)
        self.assertIn("[remote-step] chmod-script", output)
        self.assertIn("[remote-step] install-game", output)
        self.assertIn("[remote-step] start-tmux", output)
        self.assertIn("[remote-step] verify-tmux", output)
